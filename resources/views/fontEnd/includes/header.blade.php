                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            @foreach($publishedCatagory as $Catagory)
                            <li class="dropdown menu__item">
                                <a href="{{url('/catagory/'.$Catagory->id)}}" class="dropdown-toggle menu__link">{{$Catagory->categoryName}} </a>
                            </li>
                            @endforeach
            ...
            <div class="cart box_1">
                <a href="{{url('/showCart/')}}">
                    <h3> <div class="total">
                            ...
                            <span></span>{{Cart::total()}}</span>({{Cart::count()}}items)</div>
