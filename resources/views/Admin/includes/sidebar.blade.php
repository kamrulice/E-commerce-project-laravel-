                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Users Info <span class="fa arrow"></span></a>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Slider Image<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/add/image')}}">Add Image</a>
                                </li>
                                <li>
                                    <a href="{{url('/image/manage')}}">Manage Image</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="{{url('/manage/customer')}}"><i class="fa fa-bar-chart-o fa-fw"></i>Manage Customer  </a>
                        </li>
                        <li>
